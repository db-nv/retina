...
#     fast_image_resize("./data/train/", "./data/images_preprocessed_150/", output_size=(150, 150))
    fast_image_resize("../data/train/", "../data/images_preprocessed_1000/", output_size=(1000, 1000))
    fast_image_resize("../data/test/", "../data/test_images_preprocessed_150/", output_size=(150, 150))
    fast_image_resize("../data/test/", "../data/test_images_preprocessed_1000/", output_size=(1000, 1000))
#     fast_image_resize("../test/images/", "../data /images_resized_150/", output_size=(150, 150))