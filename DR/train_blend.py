...
if __name__ == "__main__":
    ...
    ds = MyDataset(csv_file="../solution2.0/train_blend.csv")
    loader = DataLoader(ds, batch_size=256, num_workers=3, pin_memory=True, shuffle=True)
    ds_val = MyDataset(csv_file="../solution2.0//val_blend.csv")
    loader_val = DataLoader(
        ds_val, batch_size=256, num_workers=3, pin_memory=True, shuffle=True
    )
    ds_test = MyDataset(csv_file="../solution2.0/test_blend.csv")
