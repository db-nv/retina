...
if __name__ == "__main__":
    ...
    ds = MyDataset(csv_file="./data/train_blend.csv")
    loader = DataLoader(ds, batch_size=256, num_workers=3, pin_memory=True, shuffle=True)
    ds_val = MyDataset(csv_file="./data/val_blend.csv")
...
#     )
    ...
    print(f"Mean Abs Error (Val): {mean_absolute_error(labels, preds)}")
    make_prediction(model, loader_val, "val_blend_preds.csv")
